...
def relabel(tensor):
    # TODO: mine
    # Change pixel values in the output tensor so that
    # they are bounded between 0 and (number of  classes - 1).
    # Relabelling is according to Cityscapes dataset, see VisualizeResults.py
    tensor[tensor == 255] = 19
    tensor[tensor == 33] = 18
    tensor[tensor == 32] = 17
    tensor[tensor == 31] = 16
    tensor[tensor == 28] = 15
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_epochs', type=int, default=3, help='Max. number of epochs')
